...
$lang['config_writable'] = 'Vérifier les permission d\'écriture du fichier config';
...
$lang['estrict_enabled'] = 'E_STRICT est activé dans "error_reporting" de PHP. Bien que cela n\'empêchera pas CMSMS™ de fonctionner, il peut se produire des affichage d\'avertissements sur l\'écran, en particulier des anciens modules tiers.';
...
$lang['fail_database_support'] = 'Aucun pilotes compatible avec la base de données';
...
$lang['fail_session_use_cookies'] = 'Les "sessions" ne sont pas configurées pour utiliser des cookies';
...
$lang['func_tempnam'] = 'Vérification pour la fonction "tempnam"';
$lang['func_gzopen'] = 'Vérification pour la fonction "gzopen"';
...
$lang['install_initevents'] = 'Création des événements';
...
$lang['no'] = 'Non';
$lang['none'] = 'Aucun';
$lang['open_basedir'] = 'Restriction "open_basedir"';
...
$lang['step2_nocmsms'] = 'Nous n\'avons pas trouvé d\'installation de CMS Made Simple™ dans ce dossier. Il semble donc que vous voulez faire une nouvelle installation.';
...
$lang['step9_removethis'] = '<strong>ATTENTION</strong> Pour des raisons de sécurité, il est important que vous supprimez l\'assistant d\'installation de votre hébergement dès que vous aurez vérifié la réussite de l\'opération.';
$lang['symbol'] = 'Symbole';
$lang['social_message'] = 'CMS Made Simple™ a été installé correctement !';
$lang['test_failed'] = 'Un test requis à échoué';
...
$lang['upgrade_deleteoldevents'] = 'Suppression des anciens événements';
